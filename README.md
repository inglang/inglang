...
재미삼아 만들어본 언어여서 굉장히 허술하고 이상할 수 있습니다. 이상할 경우 PR 해주시면 감사하겠습니다.(수정안 될 가능성 농후)

인터프리터를 js로도 구현했습니다. 예시 인터프리터는 [호스팅 페이지](https://inglang.github.io/inglang/nodejs/view/index.html)에서 테스트해보실 수 있습니다.
